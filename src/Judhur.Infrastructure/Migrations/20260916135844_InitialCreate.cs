        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BannedReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModifiedUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PropertyType = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    PropertyStatus = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_BuyerId_SellerId_PropertyId",
                table: "Conversations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_ModerationStatus_IsActive",
                table: "Properties",
                columns: new[] { "ModerationStatus", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_SellerId_ReviewerId",
                table: "Reviews",
